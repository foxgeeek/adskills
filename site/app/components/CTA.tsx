...
export function CTA() {
  return (
    <section className="relative px-6 sm:px-10 py-24 sm:py-28 border-t border-ink-800">
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="relative border border-jade-400/30 bg-ink-900/50 backdrop-blur p-10 sm:p-16">
          ...
          <h2 className="font-[family-name:var(--font-fraunces)] text-5xl sm:text-7xl leading-[0.95] tracking-[-0.025em] text-ink-50 max-w-3xl">
            Stop <em className="italic font-light text-ink-300">clicking.</em> Start{' '}
            <span className="shimmer-text font-medium">shipping.</span>
          </h2>

          <p className="mt-8 max-w-xl text-lg text-ink-300 leading-relaxed">
            Fork the repo, wire up OAuth for your platforms, and pipe natural
            language into your ad accounts. MIT licensed &mdash; bring it
            into your agency, extend it, rebrand it.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            ...
            <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-ink-500 flex items-center gap-2">
              ...
              <span>to search skills — coming soon</span>
            </span>
          </div>
        </div>
      </div>
